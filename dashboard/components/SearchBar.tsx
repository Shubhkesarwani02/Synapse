    ...
    <div className="mb-12">
      <div className="relative max-w-3xl mx-auto">
        <input
          ...
          className="w-full px-6 py-5 text-lg rounded-2xl shadow-xl border-2 border-transparent focus:border-purple-500 focus:outline-none bg-white text-gray-900 placeholder-gray-400"
          disabled={loading}
          style={{ color: '#111827' }} // Ensure text is visible
        />
